...
import { sampleWithRequiredData } from '../prontuario.test-samples';
...
describe('Prontuario Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.prontuarios?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to prontuarioService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProntuarioIdentifier');
      const id = comp.trackId(entity);
      expect(service.getProntuarioIdentifier).toHaveBeenCalledWith(entity);
