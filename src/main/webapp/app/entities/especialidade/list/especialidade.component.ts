...
export class EspecialidadeComponent implements OnInit {
  ...
  protected readonly especialidadeService = inject(EspecialidadeService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IEspecialidade): number => this.especialidadeService.getEspecialidadeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.especialidades = this.refineData(dataFromBody);
  }

  protected refineData(data: IEspecialidade[]): IEspecialidade[] {
