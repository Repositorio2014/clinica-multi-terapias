...
import { sampleWithRequiredData } from '../agenda.test-samples';
...
describe('Agenda Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to agendaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAgendaIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAgendaIdentifier).toHaveBeenCalledWith(entity);
