...
import { sampleWithRequiredData } from '../profissional.test-samples';
...
describe('Profissional Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.profissionals?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to profissionalService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProfissionalIdentifier');
      const id = comp.trackId(entity);
      expect(service.getProfissionalIdentifier).toHaveBeenCalledWith(entity);
